...
public class RequestUtils {
    ...
    public static String getRequestedSessionId(HttpServletRequest request) {
        ...
        if (request.isRequestedSessionIdFromURL() || StringUtils.isBlank(ctx)) {
            ...
            // 手动从cookie获取
            String cookieValue = CookieUtils.getCookie(request, Constants.JSESSION_COOKIE);
            if (cookieValue != null) {
                return cookieValue;
            } else {
                return null;
    ...
    /**
     * 获取ip地址(新增2014-8-19 11:47:15 by LIJUNJIE)
     * @param request
     * @param response
     * @return
     */
    public static String getCusIpAddr(HttpServletRequest request) {
